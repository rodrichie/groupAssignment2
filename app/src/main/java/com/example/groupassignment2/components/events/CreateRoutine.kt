...
fun CreateRoutine(navController: NavHostController) {
    ...
    val isShowingDialog =
        navController.previousBackStackEntry?.arguments?.getBoolean("isShowingDialog") ?: false
    if (isShowingDialog) timePickerDialog.show()

    val openAlert =
        navController.previousBackStackEntry?.arguments?.getBoolean("openAlert") ?: false
    ...
    Scaffold(
        topBar = {
            MyToolbar(
                ...
                title = title,
                iconsList2 = iconsList2,
                navController,
                routeList1 = routeList1,
                routeList2 = routeList2
            )
        }
